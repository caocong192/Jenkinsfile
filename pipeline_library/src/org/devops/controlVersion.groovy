...
// def AddVersion(){
//     sh """
//         cd ${workspace}/CICD; /usr/bin/git pull origin master
//         chmod a+x ./Gitlab_Add_Version.sh; ./Gitlab_Add_Version.sh
//         /usr/bin/git add Branch_Version.txt; /usr/bin/git commit -m 'Build Success! ${BranchName} Version add'; /usr/bin/git push origin HEAD:master
//     """
// }
